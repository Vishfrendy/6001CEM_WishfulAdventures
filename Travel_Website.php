	...
	<head>
		...
		<style>
			...
			.story-container {
				...
				margin: 0 auto;
				display: grid;
				grid-template-columns: repeat(3, 1fr); /* Set 4 equal columns */
				gap: 20px;
				padding: 10px;
			}
	...
	<body>
		...
		<div class="container">
			...
			<div class="like-container">
				...
				<p>Popular Countries to visit</p>
			</div>
			...
			<?php
				...
				echo '</div>';
			?>
			<!---------- End of Destinations Sections ---------->
			
			<!---------- Travel Stories Sections ---------->
			<div class="like-container">
			...
			<?php
				...
				// Step 3: Fetch data from the 'stories' table
				...
				echo '</div>';
			?>
			<!---------- End of Travel Stories Sections ---------->
